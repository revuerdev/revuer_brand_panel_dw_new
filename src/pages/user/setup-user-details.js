import profilestatus from "../../assets/images/profile-3.svg";
...
import { campaignCreate } from "../../context/actions/campaign"
...
function SetupUserDetails() {
  ...
  const samplingImageUploader = (e) => {
    ...
    const file = e.target.files[0],
      reader = new FileReader();
    reader.onloadend = function () {
      setSamplingAfterUploadicon({ filename: file.name, imageSrc: "https://revadmin.appdevwing.club/uploads/campaigns/document.png", imageObj: reader.result.replace(/^data:.+;base64,/, '') })
    };
  ...
  const surveyImageUploader = (e) => {
    ...
    const file = e.target.files[0],
      reader = new FileReader();
    reader.onloadend = function () {
      setSurveyAfterUploadicon({ filename: file.name, imageSrc: "https://revadmin.appdevwing.club/uploads/campaigns/document.png", imageObj: reader.result.replace(/^data:.+;base64,/, '') })
    };
  ...
  return (
    <>
      <section className="w-11/12 md:w-10/12 lg:w-5/6 sub-width-1 mx-auto">
        <div className="block sm:flex justify-center items-center mt-9 mb-12">
          <img
            src={profilestatus}
            alt="profilestatus"
          ...
          />
          <div>
            <p className="text-2xl font-normal text-center sm:text-left pt-5 sm:pt-0">
              <span className="font-bold pr-2">Welcome,</span>{brandDataDetails.first_name} {brandDataDetails.last_name}
            </p>
            <p className="text-center text-sm sm:text-left">
              Readys to access our pool of trained RevueRS? Let’s do it in 3
              quick steps
            </p>
          </div>
        </div>

        <div className="border-b-2 border-dashed border-[#283E39] w-5/6 md:5/6 lg:w-[67%] mx-auto relative sm:mb-20 mb-24">
          ...
          <div className="absolute top-[-22px] left-[43%] md:left-[43%] lg:left-[47%]">
            <div className="w-10 h-10 bac-6 rounded-full text-white flex justify-center items-center">
              <img src={standerdicon} alt="standerdicon" />
            </div>
          </div>

          <div className="absolute top-[-22px] right-0">
            <div className="w-10 h-10 bac-7 rounded-full text-white bac-7 flex justify-center items-center">
              3
            </div>
          </div>

          <div className="font-10 absolute top-8 left-[-35px] font-semibold text-[9px] sm:text-sm">
            Purchase a plan
          </div>

          <div className="font-10 absolute top-8 left-[36%] md:left-[37%] lg:left-[42.5%] pr-3 font-semibold lable-color text-[9px] sm:text-sm">
            Setup Your Profile
          </div>

          <div className="font-10 absolute top-8 right-[-32px] md:right-[-45px] lg:right-[-70px] font-semibold text-[9px] sm:text-sm lable-color">
        ...
        <form onSubmit={handleSubmit((data, event) => onSubmit(data, event))} className="theme-form ng-untouched ng-pristine ng-valid" method="post">
          <div className="mb-10">
            <h5 className="text-xl font-semibold lable-color mb-2">
              Campaign Details<span className="text-[#E74C3C]">*</span>
            </h5>
            <div className="md:block lg:flex block box-shadow-1 rounded-2xl pt-10">
              <div className="flex-initial w-full md:full lg:w-7/12 bac-1 py-8 px-8 pr-4 md:py-5 lg:py-0 mr-2 mb-0 md:mb-2 lg:mb-5">
                ...
                <div className="block mb-4 relative">
                  <input
                    ...
                    required=""
                    className="box-shadow-3 h-12 px-2 rounded-lg border border-[#95A5A6] bg-white w-full mt-2 mb-1 text-sm focus:outline-none"
                  />
                ...
                <div className="block relative">
                  <textarea
                    className="resize-none mb-5 h-20 py-3 px-2 rounded-lg border box-shadow-3 border-[#95A5A6] bg-white w-full mt-2  text-sm focus:outline-none"
                    name="campObjective"
                ...
                <div className="sm:flex block w-full float-right mb-2">
                  <div className="flex-initial w-full sm:w-6/12 mr-4">
                  ...
                  <div className="flex-initial w-full sm:w-6/12" ref={ref}>
                    <label className="lable-color text-sm tracking-wide font-semibold">
                      Campaign Date Range
                    </label>
                    <div className="block relative">
              ...
              <div className="flex-initial w-full md:11/12 lg:w-6/12 bac-1 py-5 px-8 sm:px-2 md:py-5 lg:py-0 mr-5 mb-0 md:mb-2 sm:mb-0">
                <h4 className="text-base font-medium mb-3 sm:mb-2">
                  Cover Image
                </h4>
            ...
            <>
              <div className="mb-10">
                ...
                <div className="md:block lg:flex block box-shadow-1 rounded-2xl pt-3 sm:pt-7 mb-6 sm:mb-8 px-4 sm:px-4 relative">
                  ...
                  <div
                    className="flex-initial w-full md:11/12 lg:w-6/12 bac-1 py-2 sm:py-12 px-4 sm:px-2 pr-4 md:py-5 lg:py-0 mb-0 md:mb-2 lg:mb-5">
                    <label className="mt-10 mb-2 lable-color text-base font-semibold"> Buy Link / Select check box below</label>
                    <div className="block mb-2 relative">
              ...
              <div className="mb-10">
                <h5 className="text-lg tracking-wide font-semibold lable-color mb-3">Task 2: Fill Form<span className="text-[#E74C3C]">*</span></h5>
          ...
          {displaySurveysCampaignTypeTask
            ...
            <>
              <div className="mb-10">
                <h5 className="text-lg tracking-wide font-semibold lable-color mb-3">Task 1: Fill Form<span
                  className="text-[#E74C3C]">*</span></h5>
          ...
          <div className="block sm:flex justify-center sm:justify-end items-center mb-8 relative">
            <div className="flex justify-center sm:justify-end">
              <button className="mr-8 bac-3 w-36 py-2 rounded-[7px] text-white uppercase text-base font-bold flex justify-center items-center">
                Cancel
              </button>
              <button ref={submitButton} className="bac-6 w-36 py-2 flex rounded-[7px] text-white uppercase text-base font-bold justify-center items-center" ><i className="fa fa-spin fa-spinner mr-2" id="btn_spinner"></i>Next</button>
            </div>
            <div className="absolute left-[33%] lg:left-[45%] left0 pb-8 lg:pb-2">
              <Link to={`${process.env.REACT_APP_FRONT_URL}/dashboard`} className="mt-5 underline font-base flex justify-center font-medium text-[#818A9E] tracking-widest">Skip this step</Link>
            </div>
          </div>
        </form>
      </section>
