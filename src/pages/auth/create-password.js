...
import { brandCreatePassword } from "../../context/actions/auth";
...
function CreatePassword() {
    ...
    const onSubmit = (data, event) => {
        ...
        if (password.trim() == "") {
            ...
            data.token = segment;
            dispatch(brandCreatePassword(data, submitButton, toastId))
            reset()
        }
        ...
        <div className="md:block lg:flex block">
            <div className="flex-initial w-12/12 md:w-full lg:w-7/12 flex justify-center relative bac-1">
                <div className="slider-bac-2 w-full flex">
                    <div className="md:w-[300] lg:w-[500px] mt-auto sm:h-auto">
                        <div className="pl-5 lg:pl-14 mb-20">
                            <div className="flex items-center mb-6">
                                <img src={logoImages} alt="logoImages" className="w-20 mr-4" />
                                <div className="mt-2">
                            ...
                            <h4 className="text-white text-xl lg:text-3xl font-semibold tracking-wide mb-4 leading-[45px]">India's First Professional Pool of Revuers</h4>
            ...
            <div className="flex-initial w-12/12 md:w-full lg:w-6/12 flex h-[64.8vh] lg:h-[100vh] px-8 lg:px-2 py-16 mb-10 lg:mb-0 lg:py-0">
                <div className="grid w-full md:w-[520px] lg:w-[450px] content-center mx-auto lg:mx-0">
                    <div>
                        <h5 className="text-2xl sm:text-[35px] font-bold mt-2 mb-10 lable-color">Create Password</h5>

                        <form onSubmit={handleSubmit((data, event) => onSubmit(data, event))} className="theme-form ng-untouched ng-pristine ng-valid">
                            <label htmlFor="email" className="mb-4 lable-color text-base font-semibold relative">Password</label>
                            <div className="block relative mb-2">
                                <input type="password" autoComplete="off" name="password" id="password" {...register("password")} onKeyUp={(event) => passwordValid(event)} placeholder="&#9679; &#9679; &#9679; &#9679; &#9679; &#9679;" required="" className="h-12 px-4 bg-white rounded-lg border border-[#95A5A6] w-full mt-2 mb-2 text-sm placeholder:text-[#001540] focus:outline-none" />
                                {passwordValidateError && <label className="error">{passwordValidateError}</label>}
                            </div>

                            <label htmlFor="cpassword" className="mb-4 lable-color text-base font-semibold relative">Confirm Password</label>
                            <div className="block relative">
                                <input type={passwordType ? "text" : "password"} autoComplete="off" name="cpassword" id="cpassword" {...register("cpassword")} placeholder="&#9679; &#9679; &#9679; &#9679; &#9679; &#9679;" required="" className="h-12 px-4 bg-white rounded-lg border border-[#95A5A6] w-full mt-2 mb-2 text-sm placeholder:text-[#001540] focus:outline-none" />
                            ...
                            <button ref={submitButton} className="rounded-lg py-2.5 w-full bac-2 text-white mb-5 mt-6 text-base font-bold uppercase"><i className="fa fa-spin fa-spinner mr-2" id="btn_spinner"></i>Create</button>
                        </form>
                        <div className="absolute right-6 top-5">
                            <h3 className="text-sm sm:text-lg font-normal flex justify-center text-white lg:text-[#001540] mb-4 pb-5 sm:pb-0 items-center">Already have an account?
                                <Link to={`${process.env.REACT_APP_FRONT_URL}/login`} className="font-bold text-white lg:text-[#FCB43C] pl-2" href="login-page.html"> LOG IN
                                </Link>
                            </h3>
                        </div>
                    </div>
