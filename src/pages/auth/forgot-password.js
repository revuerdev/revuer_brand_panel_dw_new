...
import { brandForgotPassword } from "../../context/actions/auth"
...
function ForgotPassword() {
    ...
    const onSubmit = (data,event) => {
        ...
        if(email.trim() == ""){
            ...
            dispatch(brandForgotPassword(data,navigate,submitButton,toastId))
            reset()
        }
    }
            ...
            <div className="md:block lg:flex block">
                ...
                <div className="flex-initial w-12/12 md:w-full lg:w-6/12 flex h-[64.8vh] lg:h-[100vh] px-8 lg:px-2 py-16 mb-10 lg:mb-0 lg:py-0">
                    <div className="grid md:w-[520px] lg:w-[450px] content-center  mx-auto lg:mx-0">
                        <div>
                            <h5 className="text-2xl sm:text-[35px] font-bold -mt-10 mb-5 lable-color">Forgot Your Password</h5>
                            ...
                            <form onSubmit={handleSubmit((data, event) => onSubmit(data, event))} className="theme-form ng-untouched ng-pristine ng-valid">
                                ...
                                <button ref={submitButton} className="py-2.5 w-full bac-2 text-white mb-5 mt-6 text-base font-bold rounded-lg uppercase"><i className="fa fa-spin fa-spinner mr-2" id="btn_spinner"></i>Reset Password</button>
                            </form>
