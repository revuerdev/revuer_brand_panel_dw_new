...
import { getRevuerOngoingReport, getOngoingCampaignNames } from "../../context/actions/analysis"
...
function Dassbord() {
    ...
    const revuerOngoingReportData = useSelector((state) => state.revuerOngoingReport);
    const campignNamesData = useSelector((state) => state.getongoingCampaignName);
    console.log("revuerOngoingReportData", revuerOngoingReportData)
    var activePageCount = revuerOngoingReportData?.recordsTotal != undefined ? Math.ceil(revuerOngoingReportData?.recordsTotal / 10) : ''
    var pageStart = revuerOngoingReportData && Number(revuerOngoingReportData?.start)
    useEffect(() => {
        ...
        dispatch(getOngoingCampaignNames({ token: brandlogin_unique_token }))
    ...
    const onSubmit = (data, event) => {
        ...
        data.pageValue = 0
        if (data.type != "") {
            dispatch(getRevuerOngoingReport(data, submitButton, toastId))
        } else {
    ...
    const activePagination = (activePageNumber) => {
        dispatch(getRevuerOngoingReport({ ...formData, pageValue: activePageNumber }, submitButton, toastId))
    }
    const reviewPagination = (reviewPageNumber) => {
        dispatch(getRevuerOngoingReport({ ...formData, pageValue: reviewPageNumber }, submitButton, toastId))
    }
    ...
    return (
        <>
                ...
                <div className="px-5">
                    <div className="bg-white box-shadow-1 rounded-2xl px-7 pt-3 mb-5 px0">
                        <div className="flex justify-between mt-2 items-center mb-6">
                            <h6 className="text text-xl font-semibold pl-3">Ongoing Report</h6>
                            {revuerOngoingReportData.recordsTotal != undefined &&
                                <h3 className="text-md sm:text-sm font-semibold px-5 rounded-lg py-2">Number of Records : <span>{revuerOngoingReportData.recordsTotal}</span></h3>
                            }
                        </div>
                        ...
                        <div className="px-2">
                            {revuerOngoingReportData.getCamData &&
                                                    ...
                                                    <div className="md:block lg:flex block">
                                                        <div className="flex-initial w-full md:full lg:w-4/12 bac-1 py-1  pr-4 md:py-1 lg:py-0 mr-2 mb-0 md:mb-2 lg:mb-2">
                                                            ...
                                                            <h5 className="text-xs font-medium text-sky-400/100">
                                                                <a href={'campaign-task-details/' + revuerOngoingReportData?.getCamData.campaign_token} className="break-all" target="_blank">{revuerOngoingReportData?.getCamData.campaign_name}</a>
                                                            </h5>
                                                        </div>
                                                        <div className="flex-initial w-full md:full lg:w-4/12 bac-1 py-5 pr-4 md:py-1 lg:py-0 mr-2 mb-0 md:mb-2 lg:mb-2">
                                                            ...
                                                            <h5 className="text-xs font-medium font-8">
                                                                {revuerOngoingReportData?.getCamData.brand_name}
                                                            </h5>
                                                        </div>
                                                        <div className="flex-initial w-full md:full lg:w-4/12 bac-1 py-5 pr-4 md:py-1 lg:py-0 mr-2 mb-0 md:mb-2 lg:mb-2">
                                                            <h3 className="color-3 text-xs font-normal mb-2">
                                                            ...
                                                            <h5 className="text-xs font-medium font-8">
                                                                {revuerOngoingReportData?.getCamData.cam_type_name}
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div className="md:block lg:flex block">
                                                        <div className="flex-initial w-full md:full lg:w-4/12 bac-1 py-1  pr-4 md:py-1 lg:py-0 mr-2 mb-0 md:mb-2 lg:mb-2">
                                                            ...
                                                            <h5 className="text-xs font-medium">
                                                                {revuerOngoingReportData?.getCamData.createdAt}
                                                            </h5>
                                                        </div>
                                                        <div className="flex-initial w-full md:full lg:w-4/12 bac-1 py-5 pr-4 md:py-1 lg:py-0 mr-2 mb-0 md:mb-2 lg:mb-2">
                                                            <h3 className="color-3 text-xs font-normal mb-2">
                                                            ...
                                                            <h5 className="text-xs font-medium font-8">
                                                                {revuerOngoingReportData?.getCamData.updatedAt}
                                                            </h5>
                                                        </div>
                                                        <div className="flex-initial w-full md:full lg:w-4/12 bac-1 py-5 pr-4 md:py-1 lg:py-0 mr-2 mb-0 md:mb-2 lg:mb-2">
                                                            <h3 className="color-3 text-xs font-normal mb-2">
                                                            ...
                                                            <h5 className="text-xs font-medium font-8">
                                                                {revuerOngoingReportData?.getCamData.start_date} - {revuerOngoingReportData?.getCamData.last_date}
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="flex-initial w-full md:full lg:w-12/12 bac-1 py-2 pr-4 mr-2 mb-0 md:mb-2 lg:mb-2">
                                                    <div className="md:block lg:flex block">
                                                        <div className="flex-initial w-full md:full lg:w-4/12 bac-1 py-1  pr-4 md:py-1 lg:py-0 mr-2 mb-0 md:mb-2 lg:mb-2">
                                                            ...
                                                            <h5 className="text-xs font-medium">
                                                                {revuerOngoingReportData?.getCamData.revuerLimit}
                                                            </h5>
                                                        </div>
                                                        <div className="flex-initial w-full md:full lg:w-4/12 bac-1 py-5 pr-4 md:py-1 lg:py-0 mr-2 mb-0 md:mb-2 lg:mb-2">
                                                            <h3 className="color-3 text-xs font-normal mb-2">
                                                            ...
                                                            <h5 className="text-xs font-medium font-8">
                                                                {revuerOngoingReportData?.getCamData.appliedCampaign}
                                                            </h5>
                                                        </div>
                                                        <div className="flex-initial w-full md:full lg:w-4/12 bac-1 py-5 pr-4 md:py-1 lg:py-0 mr-2 mb-0 md:mb-2 lg:mb-2">
                                                            <h3 className="color-3 text-xs font-normal mb-2">
                                                            ...
                                                            <h5 className="text-xs font-medium font-8">
                                                                {revuerOngoingReportData?.getCamData.approvedCampaign}
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="flex-initial w-full md:full lg:w-12/12 bac-1 py-2 pr-4 mr-2 mb-0 md:mb-2 lg:mb-2">
                                                    <div className="md:block lg:flex block">
                                                        <div className="flex-initial w-full md:full lg:w-4/12 bac-1 py-1  pr-4 md:py-1 lg:py-0 mr-2 mb-0 md:mb-2 lg:mb-2">
                                                            ...
                                                            <h5 className="text-xs font-medium">
                                                                {revuerOngoingReportData?.getCamData.completedCampaign}
                                                            </h5>
                                                        </div>
                                                        <div className="flex-initial w-full md:full lg:w-4/12 bac-1 py-5 pr-4 md:py-1 lg:py-0 mr-2 mb-0 md:mb-2 lg:mb-2">
                                                            <h3 className="color-3 text-xs font-normal mb-2">
                                                            ...
                                                            <h5 className="text-xs font-medium font-8">
                                                                {revuerOngoingReportData?.getCamData.ongoingCampaign}
                                                            </h5>
                                                        </div>
                                                        <div className="flex-initial w-full md:full lg:w-4/12 bac-1 py-5 pr-4 md:py-1 lg:py-0 mr-2 mb-0 md:mb-2 lg:mb-2">
                                                            <h3 className="color-3 text-xs font-normal mb-2">
                                                            ...
                                                            <h5 className="text-xs font-medium font-8">
                                                                {revuerOngoingReportData?.getCamData.budget}
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="flex-initial w-full md:full lg:w-12/12 bac-1 py-2 pr-4 mr-2 mb-0 md:mb-2 lg:mb-2">
                                                    <div className="md:block lg:flex block">
                                                        <div className="flex-initial w-full md:full lg:w-4/12 bac-1 py-1  pr-4 md:py-1 lg:py-0 mr-2 mb-0 md:mb-2 lg:mb-2">
                                                            ...
                                                            <h5 className="text-xs font-medium">
                                                                {revuerOngoingReportData?.getCamData.earn_upto}
                                                            </h5>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                <div id="first" className="pt-6 text-xs text-justify">
                                    <div className="overflow-auto mb-5">
                                        <table className="table-auto w-full">
                                            <thead>
                                                ...
                                                <tr className="h-4"></tr>
                                                {
                                                    revuerOngoingReportData.data ?
                                                        revuerOngoingReportData.data == null || revuerOngoingReportData.data.length > 0 ?
                                                            revuerOngoingReportData.data.map((item, index) => {
                                    ...
                                    <div className="flex justify-end textjustify">
                                        <ul className="flex mb-6">
                                            ...
                                            {
                                                revuerOngoingReportData.data && Array(activePageCount).fill(activePageCount).map((item, index) => (
                                                    <li className={`${(Number(revuerOngoingReportData.start) / 10 + 1 == index + 1) ? "bac-6 text-white text-sm font-semibold rounded px-[1rem] py-2 mr-3" : "border border-[#95A5A6] text-sm font-semibold color-3 px-3 rounded py-2 mr-3"}`}>
            ...
            <Sidebar title="Analysis" subtitle="OngoingReport" />
        </>
    );
}
