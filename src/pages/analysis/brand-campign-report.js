...
import PieChart from "../../components/Charts/dougnut-label";
                                ...
                                <div className=" flex-initial w-full md:w-full  lg:w-12/12  py-6">
                                    <div className="box-shadow-1 rounded-xl px-6 py-5 relative">
                                        ...
                                        <div className=" sm:pb-0 md:pt-[5.8rem] md:pb-[0rem] lg:py-[1.9rem]">
                                            <div className="mb-5">
                                                <div className="-ml-12 pie-chart" style={{ width: "100%" }}>
                                                        ...
                                                        datasets: [
                                                            {
                                                                ...
                                                                data: brandCampaignReport?.impressionsNumber!=undefined?brandCampaignReport?.impressionsNumber.filter(n=>n!=0):["100"],
                                                                cutout: "100%",
                                                                borderWidth: 0,
                                                                fontColor: "white",
                                                                cutout: "75%",
                                                    ...
                                                    <PieChart
                                                        ...
                                                        data={brandCampaignReport?.impressionsNumber != undefined ? brandCampaignReport?.impressionsNumber.filter(n => n != 0) : ["100"]}
                                                        colors={brandCampaignReport?.impressionsNumber?.filter(n => n != 0).length > 0 ? backgroundColor.impressions : ["#dae0e5"]}
                                                    />
                                                </div>
                                            </div>
                                            <div className="absolute pie-chart-label bottom-0 md:top-[5%] lg:top-[30%]  md:right-8  lg:right-20 mt-5">
                                                <div className="block ">
                                                    {brandCampaignReport?.impressionsNumber?.map((item, index) => {
                                                                ...
                                                                <div className="flex items-center mb-4">
                                                                    <div className="flex items-center mb-4">
                                                                        ...
                                                                        <h2 className="text-xs sm:text-sm">
                                                                            {brandCampaignReport?.brandName[index]}
                                        ...
                                        <div className=" sm:pb-0 md:pt-[5.8rem] md:pb-[0rem] lg:py-[1.9rem]">
                                            <div className="mb-5">
                                                <div className="-ml-12 pie-chart" style={{ width: "100%" }}>
                                                    ...
                                                    <PieChart
                                                        width={500} height={500}
                                                        data={brandCampaignReport?.engagementNumber != undefined ? brandCampaignReport?.engagementNumber.filter(n => n != 0) : ["100"]}
                                                        colors={brandCampaignReport?.engagementNumber?.filter(n => n != 0).length > 0 ? backgroundColor.engagement : ["#dae0e5"]}
                                                    />
                                                </div>
                                            </div>
                                            <div className="absolute pie-chart-label bottom-0 md:top-[5%] lg:top-[30%]  md:right-8  lg:right-20 mt-5">
                                        ...
                                        <div className=" sm:pb-0 md:pt-[5.8rem] md:pb-[0rem] lg:py-[1.9rem]">
                                            <div className="mb-5">
                                                <div className="-ml-12 pie-chart" style={{ width: "100%" }}>
                                                    ...
                                                    <PieChart
                                                        width={500} height={500}
                                                        data={brandCampaignReport?.commentNumber != undefined ? brandCampaignReport?.commentNumber.filter(n => n != 0) : ["100"]}
                                                        colors={brandCampaignReport?.commentNumber?.filter(n => n != 0).length > 0 ? backgroundColor.comment : ["#dae0e5"]}
                                                    />
                                                </div>
                                            </div>
                                            <div className="absolute pie-chart-label bottom-0 md:top-[5%] lg:top-[30%]  md:right-8  lg:right-20 mt-5">
                                        ...
                                        <div className=" sm:pb-0 md:pt-[5.8rem] md:pb-[0rem] lg:py-[1.9rem]">
                                            <div className="mb-5">
                                                <div className="-ml-12 pie-chart" style={{ width: "100%" }}>
                                                    ...
                                                    <PieChart
                                                        width={500} height={500}
                                                        data={brandCampaignReport?.reachNumber != undefined ? brandCampaignReport?.reachNumber.filter(n => n != 0) : ["100"]}
                                                        colors={brandCampaignReport?.reachNumber?.filter(n => n != 0).length > 0 ? backgroundColor.reach : ["#dae0e5"]}
                                                    />
                                                </div>
                                            </div>
                                            <div className="absolute pie-chart-label bottom-0 md:top-[5%] lg:top-[30%]  md:right-8  lg:right-20 mt-5">
                                        ...
                                        <div className=" sm:pb-0 md:pt-[5.8rem] md:pb-[0rem] lg:py-[1.9rem]">
                                            <div className="mb-5">
                                                <div className="-ml-12 pie-chart" style={{ width: "100%" }}>
                                                    ...
                                                    <PieChart
                                                        width={500} height={500}
                                                        data={brandCampaignReport?.videoViewNumber != undefined ? brandCampaignReport?.videoViewNumber.filter(n => n != 0) : ["100"]}
                                                        colors={brandCampaignReport?.videoViewNumber?.filter(n => n != 0).length > 0 ? backgroundColor.videoView : ["#dae0e5"]}
                                                    />
                                                </div>
                                            </div>
                                            <div className="absolute pie-chart-label bottom-0 md:top-[5%] lg:top-[30%]  md:right-8  lg:right-20 mt-5">
