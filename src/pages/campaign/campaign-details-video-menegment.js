...
function CampaignDetailsTestimonial() {
...
<div className="px-5 sm:px-8">
                ...
                <div className="sm:flex block w-full social-break float-right mb-2">
                  <div className="flex-initial w-full sub-width-2 sm:w-6/12 mr-6">
                    ...
                    <div className="custom-select mt-2">
                      <select>
                        <option className="select-options color-3" value="0">Visual/Video Review</option>
    ...
    <div className="mb-10">
        ...
        <div className="md:block lg:flex block box-shadow-1 rounded-2xl pt-3 sm:pt-7 mb-6 sm:mb-8 relative">
            <div className="flex-initial w-full md:11/12 lg:w-7/12 bac-1 py-2 sm:py-12 px-4 sm:px-8 pr-4 md:py-5 lg:py-0 mr-2 mb-0 md:mb-2 lg:mb-5">
                <label className="mt-10 mb-2 lable-color text-sm tracking-wide font-semibold">Product Details</label>
                <div className="block mb-2">
                    <textarea
                        className="resize-none mb-2 h-32 py-3 box-shadow-3 px-2 rounded-lg border border-[#95A5A6] bg-white w-full mt-2 text-sm placeholder-[#95A5A6]"
      ...
      onChange={()=>setChecked({buy:!checked.buy})}
        ...
        />
            ...
            <div className="flex-initial w-full md:11/12 lg:w-7/12 bac-1 py-2 sm:py-12 px-8 pr-4 md:py-5 lg:py-0 mr-2 mb-0 md:mb-2 lg:mb-5">
                <div className="md:block lg:flex block mb-1 rounded-lg relative">
                    <div className="flex-initial w-full md:11/12 lg:w-6/12 bac-1 mr-3">
                        <label className="mt-6 mb-4 lable-color text-sm tracking-wide font-semibold">Amazon Product Link </label>
                        <div className="block mb-2 relative">
                            <input type="text" id="email" placeholder="Paste link here" required="" className="box-shadow-3 mb-3 h-10 px-4 rounded-lg border border-[#95A5A6] bg-white lable-color w-full mt-2 text-sm placeholder-[#95A5A6]" />
                    ...
                    <div className="flex-initial w-full md:11/12 lg:w-6/12 bac-1 mr-3">
                        <label className="mt-6 mb-4 lable-color text-sm tracking-wide font-semibold">Flipkart Product Link</label>
                        <div className="block mb-2 relative">
                            <input type="text" id="email" placeholder="Paste link here" required="" className="mb-3 h-10 px-4 rounded-lg border border-[#95A5A6] bg-white lable-color w-full mt-2 text-sm placeholder-[#95A5A6]" />
                            <div className="absolute top-[1.2rem] right-4">
                            <img src={linkicon} alt="linkicon" className="w-4" />
                            </div>
                        </div>
                ...
                <div className="md:block lg:flex block mb-5 rounded-lg relative">
                    <div className="flex-initial w-full md:11/12 lg:w-6/12 bac-1 mr-3">
                        <label className="mt-6 mb-4 lable-color text-sm tracking-wide font-semibold">Myntra Product Link </label>
                        <div className="block mb-2 relative">
                            <input type="text" id="email" placeholder="Paste link here" required="" className="box-shadow-3 mb-3 h-10 px-4 rounded-lg border border-[#95A5A6] bg-white lable-color w-full mt-2  text-sm placeholder-[#95A5A6]" />
                            <div className="absolute top-[1.2rem] right-4">
                            <img src={linkicon} alt="linkicon" className="w-4" />
                    ...
                    <div className="flex-initial w-full md:11/12 lg:w-6/12 bac-1 mr-3">
                        <label className="mt-6 mb-4 lable-color text-sm tracking-wide font-semibold">Big Basket Product Link</label>
                        <div className="block mb-2 relative">
                            <input type="text" id="email" placeholder="Paste link here" required="" className="box-shadow-3 mb-3 h-10 px-4 rounded-lg border border-[#95A5A6] bg-white lable-color w-full mt-2  text-sm placeholder-[#95A5A6]" />
                            <div className="absolute top-[1.2rem] right-4">
                            <img src={linkicon} alt="linkicon" className="w-4" />
                            ...
                            <img src={whiteiicon} alt="whiteiicon" className="w-4" />
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div className="mb-10">
            ...
            <div className="md:block lg:flex block box-shadow-1 rounded-2xl pt-1 sm:pt-7 relative">
                <div className="flex-initial w-full md:11/12 lg:w-full bac-1 py-5 sm:py-12 px-8 pr-4 md:py-5 lg:py-0 mr-2 mb-0 md:mb-2 lg:mb-5">
                    ...
                    <div className="block mb-2">
                        <textarea
                            className="resize-none mb-2 h-32 py-3 px-2 box-shadow-3 rounded-lg border border-[#95A5A6] bg-white w-full mt-2 text-sm placeholder-[#95A5A6]"
                            id="exampleFormControlTextarea1"
                            rows="3"
                            placeholder="Write from here"
                        ></textarea>
        ...
        <div className="mb-10">
            <h5 className="text-lg tracking-wide font-semibold lable-color mb-3">Task 3: Script Approval*<span className="text-[#E74C3C]">*</span></h5>
            <div className="md:block lg:flex block box-shadow-1 rounded-2xl pt-1 sm:pt-7 relative">
                <div className="flex-initial w-full md:11/12 lg:w-full bac-1 py-5 sm:py-12 px-8 pr-4 md:py-5 lg:py-0 mr-2 mb-0 md:mb-2 lg:mb-5">
                    <label className="mt-10 mb-2 lable-color text-sm tracking-wide font-semibold"> Script Details</label>
                    <div className="block mb-2">
                        <textarea
                            className="resize-none mb-2 h-32 py-3 px-2 box-shadow-3 rounded-lg border border-[#95A5A6] bg-white w-full mt-2 text-sm placeholder-[#95A5A6]"
                            id="exampleFormControlTextarea1"
        ...
        <div className="mb-10">
            <h5 className="text-lg tracking-wide font-semibold lable-color mb-3">Task 4: Draft Upload<span className="text-[#E74C3C]">*</span></h5>
            <div className="md:block lg:flex block box-shadow-1 rounded-2xl pt-1 sm:pt-7 relative">
                <div className="flex-initial w-full md:11/12 lg:w-full bac-1 py-5 sm:py-12 px-8 pr-4 md:py-5 lg:py-0 mr-2 mb-0 md:mb-2 lg:mb-5">
     ...
     onChange={()=>setChecked({buugest:!checked.buugest})}
          ...
          value="option1"
        />
                        <label className="form-check-label text-[9px] font-medium inline-block text-black sm:text-sm" htmlFor="inlineCheckbox1">Ask revuer to upload a video.</label>
                    </div>
                </div>
            </div>
        </div>
        <div className="mb-10">
            <h5 className="text-lg tracking-wide font-semibold lable-color mb-3">Task 5: Publish upon Approval<span className="text-[#E74C3C]">*</span></h5>
            <div className="md:block lg:flex block box-shadow-1 rounded-2xl pt-1 sm:pt-7 pb-10 lg:pb-0 relative">
                <div className="flex-initial w-full md:11/12 lg:w-6/12 bac-1 py-5 sm:py-12 px-8 pr-4 md:py-5 lg:py-0 mr-2 mb-0 md:mb-2 lg:mb-5">
                    ...
                    <div className="block mb-2">
                        <textarea
                            className="resize-none mb-2 h-32 py-3 px-2 rounded-lg box-shadow-3 border border-[#95A5A6] bg-white w-full mt-2 text-sm placeholder-[#95A5A6]"
                            id="exampleFormControlTextarea1"
                            rows="3"
                            placeholder="Write from here"
                        ></textarea>
     ...
     onChange={()=>setChecked({facebook:!checked.facebook})}
          ...
          value="option1"
        />
                        <label className="form-check-label text-[9px] font-medium inline-block text-black sm:text-xs" htmlFor="inlineCheckbox1">Ask revuer to submit a published video</label>
                    </div>
                </div>

                <div className="flex-initial w-full md:11/12 lg:w-6/12 bac-1 py-5 sm:py-12 px-2 pr-4 md:py-5 lg:py-0 mb-0 md:mb-2 lg:mb-5">
                    <label className="mt-6 lable-color text-base font-semibold mb-2">Video Duration<span className="text-[#E74C3C]">*</span></label>
                    <div className="block relative">
                    <div className="custom-select mt-2">
                      <select>
 ...
 <div class="ram">
    ...
    <a href="#" class="color-2 font-semibold underline text-xs">View More</a>
        ...
        <div className="block lg:flex justify-end items-center md:mb-5 mb-8 lg:mb-8">
           

            <div className="flex justify-end sm:justify-end">
                <button className="mr-8 bac-3 w-48 py-2 rounded text-white uppercase text-base font-bold flex justify-center items-center">Cancel</button>
                <Link to={`${process.env.REACT_APP_FRONT_URL}/campaign-details-testimonial`} className="bac-6 w-48 py-2.5 flex rounded text-white uppercase text-base font-bold justify-center items-center">Submit </Link>
            </div>
        </div>
    </div>
...
export default CampaignDetailsTestimonial