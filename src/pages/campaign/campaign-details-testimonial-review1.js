...
import { InstagramReal, FacebookModal, InstagramModal } from "../../components/Modal";
...
function CampaignDetailstestimonialReview() {
  ...
  const testimonialTaskDetailsData = useSelector((state) => state.testimonialTaskListData);
...
var resubmitcount =1;
  ...
  useEffect(() => {
    switchMainTabs();
    dispatch(getTestimonialTaskDetails({ campaign_token: campaign_token, brandlogin_unique_token: brandlogin_unique_token, revuer_token: revuer_token }, navigate))
    ...
    if (taskAprrove != 3) {
      if (remark_msg == "") {
        ...
        if (taskAprrove == 1) {
          ...
          status_title = 'Re-Submit'
          message = "Are you sure you want to Re-Submit task."
          approval_type = 2
        } else {
      ...
      toggleModal10(); setModal({ status_title: status_title, message: message, revuer_task_token: revuer_task_token, approval_type: approval_type, task_button_type: 5, remark_message: remark_msg })
    }
  }
  ...
  const onSubmit = () => {
    ...
    if (selectedCount < 2) {
      ...
      dispatch(revuerTaskApproval({ campaign_token: campaign_token, revuer_token: revuer_token, message: "Re Submitted", revuer_task_token: testimonialTaskData[2].revuer_task_token, approval_type: approval_type1, task_button_type: task_button_type1, remark_message: remark_message1, setButtonHide }, navigate))
  ...
  const taskAprrove = () => {
    ...
    var remark_message = modal.message
  ...
  return (
                    ...
                    <div className="block lg:flex justify-between items-center mb-3 lg:mb-7 pb-0 lg:pb-4">
                      ...
                      {/* <div className="block sm:flex items-center mt-2">
                        <Link
                          ...
                          className="bac-3 text-white text-sm font-semibold px-4 py-2 rounded-lg mr-5 mr5 font-11 sm:mr-8 uppercase"
                        >
                          PRev Revuer
                        </Link>
                        <Link
                          to={`${process.env.REACT_APP_FRONT_URL}/campaign-details-sampling-review`}
    ...
    transition
    focus:outline-none
    " type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo56" aria-expanded="false"
                                            ...
                                            <div id="" className="accordion-collapse" aria-labelledby="headingTwo56"
    ...
    " type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false"
                                                  ...
                                                  <h4 className="texe-sm sm:text-base mr-4 lg:mb-0 mb-0 sm:mb-2 w85 lable-color">
                                                    <span className="font-semibold">Task 2: </span>Review
                                                  </h4>
                                                  {item.revuer_task_status == "1" ?
                                                    <>
                                                      <div className="flex items-center">
                                              ...
                                              <div id="" className="accordion-collapse " aria-labelledby="headingTwo"
                                                data-bs-parent="#accordionExample">
                                                <div className="accordion-body py-4">
                                                  <div>
                                                    <p className="w-11/12 text-justify text-sm mb-4">
                                                    ...
                                                    <div className="flex mb-2">
                                                    {item.image.split(',').map((intechild, i) => {
                                                  return(
                                                    <div key={i}> 
                                                      <div className="mr-10">
                                                        <a target="_blank" href={`${process.env.VIDEO_URL}/${intechild}`}><img className="w-20" src={`${process.env.VIDEO_URL}/${intechild}`} alt="uploadicon" /></a>
                                                      </div>
                                                    </div>
                                                  )
                                                })}
    ...
    transition
    focus:outline-none
    " type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo1" aria-expanded="false"
                                                    aria-controls="collapseTwo1">
                                                    <h4 className="texe-sm sm:text-base mr-4 lg:mb-0 mb-0 sm:mb-2 w85 lable-color">
                                                      <span className="font-semibold">{item.task_visiable == "1" ? "Task 3:" : "Task 1:"}</span> Draft Upload
                                                    </h4>
                                                    {item.revuer_task_status == "1" ?
                                                      <>
                                                        <div className="flex items-center">
                                                ...
                                                <div id="" className="accordion-collapse" aria-labelledby="headingTwo1"
                                                  data-bs-parent="#accordionExample">
                                                  <div className="accordion-body py-4">
                                                    <div>
                                                      <p className="w-11/12 text-justify text-sm mb-4">
                                                      ...
                                                      }
                                                      {
                                                        <p className="w-11/12 text-justify text-sm mb-4">
                                                            ...
                                                            {Array.from({ length: 5 }, (_, index) => (
                                                              <span 
                                                                key={index}
                                                                className={`fa fa-star ${index < item.ratings ? "checked" : ""}`}
                                                              ></span>
                                                            ))}
                                                          </p>
    ...
    " type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo2" aria-expanded="false"
                                                      ...
                                                      <h4 className="texe-sm sm:text-base mr-4 lg:mb-0 mb-0 sm:mb-2 w85 lable-color">
                                                        <span className="font-semibold">{item.task_visiable == "1" ? "Task 4:" : "Task 2:"}</span> Publish Upon Approval
                                                      </h4>
                                                      {item.revuer_task_status == "1" ?
                                                        <>
                                                          <div className="flex items-center">
                                                  ...
                                                  <div id="" className="accordion-collapse" aria-labelledby="headingTwo2"
                                                    data-bs-parent="#accordionExample">
                                                    <div className="accordion-body py-4">
                                                      <div>
      ...
      <ResubmitModal status_title={resubmitModel.status_title} message={resubmitModel.message} onFailure={toggleModal13} onSuccess={onSubmit} resubmitdata={resubmitModel.resubmitdata}  />
    </>
  );
}
