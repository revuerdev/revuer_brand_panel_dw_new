...
function CampaignDetailsInfluncerOutreach() {
  ...
  <Header  welcome="Campaign " extra="Create New Campaign "showCampaign={false}/>
                ...
                <div className="mb-10 mt-6 sm:mt-0">
                    ...
                    <div className="md:block lg:flex block box-shadow-1 rounded-2xl pt-8">
                        <div className="flex-initial w-full md:full lg:w-7/12 bac-1 py-8 px-8 lg:pr-4 md:py-5 lg:py-0 mr-2 mb-0 md:mb-2 lg:mb-5">
                            ...
                            <div className="block">
                                <textarea className="resize-none mb-5 h-20 py-3 px-2 rounded-lg box-shadow-3 border border-[#95A5A6] bg-white w-full mt-2 text-sm" id="exampleFormControlTextarea1" rows="3" placeholder="Write From here"></textarea>
                            </div>
                  ...
                  <div className="flex-initial w-full sub-width-2 sm:w-6/12 mr-6">
                    ...
                    <div className="custom-select mt-2">
                      <select>
                        <option className="select-options color-3" value="0">Influencer Outreach</option>
          ...
          />
                    ...
                    <div className="mb-10">
                        ...
                        <div className="md:block lg:flex block box-shadow-1 rounded-2xl pt-1 sm:pt-7 relative">
                            <div className="flex-initial w-full md:11/12 lg:w-full bac-1 py-5 sm:py-12 px-8 pr-4 md:py-5 lg:py-0 mr-2 mb-0 md:mb-2 lg:mb-5">
                                ...
                                <div className="block mb-2">
                                    <textarea
                                        className="resize-none h-32 py-3 px-2 rounded-lg border box-shadow-3 border-[#95A5A6] bg-white w-full mt-2 mb-1 text-sm placeholder-[#95A5A6]"
                                        id="exampleFormControlTextarea1"
                                        rows="3"
                                        placeholder="Write from here"
                                    ></textarea>
            ...
            onChange={()=>setChecked({buy:!checked.buy})}
                      ...
                      value="option1"
                    />
                                    <label className="form-check-label text-[9px] font-medium inline-block text-black sm:text-sm" htmlFor="inlineCheckbox1">Ask revuer to upload a Script document.</label>
                                </div>
                            </div>
                        </div>
                    </div>
                  ...
                  <div className="relative inline-block w-[3.2rem] mr-2 align-middle select-none transition duration-200 ease-in">
                    ...
                    <div className="block lg:flex justify-end items-center md:mb-5 mb-8 lg:mb-8">
                        ...
                        <div className="flex justify-end sm:justify-end">
                            ...
                            <Link to={`${process.env.REACT_APP_FRONT_URL}/campaign-details-market-researc`} className="bac-6 w-48 py-2.5 flex rounded text-white uppercase text-base font-bold justify-center items-center">Submit </Link>
                        </div>
                    </div>
                </div>
...
export default CampaignDetailsInfluncerOutreach