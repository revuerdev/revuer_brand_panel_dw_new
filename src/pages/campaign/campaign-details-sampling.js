...
function CampaignDetailsSampling() {
...
<div className="px-5 sm:px-8">
    <div className="mb-10 mt-6 sm:mt-0">
        ...
        <div className="md:block lg:flex block box-shadow-1 rounded-2xl pt-8">
            <div className="flex-initial w-full md:full lg:w-7/12 bac-1y-8 p px-8 lg:pr-4 md:py-5 lg:py-0 mr-2 mb-0 md:mb-2 lg:mb-5">
                ...
                <div className="block">
                    <textarea className="resize-none mb-5 h-20 py-3 px-2 rounded-lg border box-shadow-3 border-[#95A5A6] bg-white w-full mt-2 text-sm" id="exampleFormControlTextarea1" rows="3" placeholder="Write From here"></textarea>
                </div>
                ...
                <div className="sm:flex block w-full social-break float-right mb-2">
                  <div className="flex-initial w-full sub-width-2 sm:w-6/12 mr-6">
                    ...
                    <div className="custom-select mt-2">
                      <select>
                        <option className="select-options color-3" value="0">Sampling</option>
          ...
          />
            ...
            <div className="flex-initial w-full md:11/12 lg:w-6/12 bac-1 md:px-8 py-5 px-7 lg:px-2 md:py-5 lg:py-0 mr-5 mb-0 md:mb-2 sm:mb-0">
                ...
                <div className="mb-10">
                    ...
                    <div className="md:block lg:flex block box-shadow-1 rounded-2xl pt-3 sm:pt-7 mb-6 sm:mb-8 relative px-5 sm:px-8">
                        <div className="flex-initial w-full md:11/12 lg:w-7/12 bac-1 py-2 sm:py-12 px-4 sm:px-0 pr-4 md:py-5 lg:py-0 mr-5 mb-0 md:mb-2 lg:mb-5">
                            <label className="mt-10 mb-2 lable-color text-sm tracking-wide font-semibold">Get a sample Product Details</label>
                            <div className="block mb-2">
                                <textarea
                                    className="resize-none mb-2 h-[8.6rem] py-3 px-2 box-shadow-3 rounded-lg border border-[#95A5A6] bg-white w-full mt-2 text-sm placeholder-[#95A5A6]"
      ...
      onChange={()=>setChecked({facebook:!checked.facebook})}
        ...
        />
                        ...
                        <div className="flex-initial w-full md:11/12 lg:w-7/12 bac-1 py-2 sm:py-12  md:py-5 lg:py-0  mb-0 md:mb-2 lg:mb-5">
                            <div className="md:block lg:flex block mb-1 rounded-lg relative">
                                <div className="flex-initial w-full md:11/12 lg:w-6/12 bac-1 mr-3">
                                    <label className="mt-6 mb-4 lable-color text-sm tracking-wide font-semibold">Address</label>
                                    <div className="block mb-2 relative">
                                        <input type="text" id="email" placeholder="Write here" required="" className="box-shadow-3 h-10 px-4 rounded-lg border border-[#95A5A6] bg-white lable-color w-full mt-2 mb-1 text-sm placeholder-[#95A5A6]" />
                                ...
                                <div className="flex-initial w-full md:11/12 lg:w-6/12 bac-1 ">
                                    <label className="mt-6 mb-4 lable-color text-sm tracking-wide font-semibold">Pin Code</label>
                                    <div className="block mb-2">
                                        <input type="text" id="email" placeholder="Enter otp here" required="" className="box-shadow-3 h-10 px-4 rounded-lg border border-[#95A5A6] bg-white lable-color w-full mt-2 mb-1 text-sm placeholder-[#95A5A6]" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="md:block lg:flex block mb-5 rounded-lg relative">
                                <div className="flex-initial w-full md:11/12 lg:w-6/12 bac-1 mr-3">
                                    <label className="mt-6 mb-4 lable-color text-sm tracking-wide font-semibold">Country</label>
                                    <div className="block mb-2 relative">
                                    <div className="custom-select mt-2">
                      <select>
                        <option className="select-options color-3" value="0">Select Country</option>
                        <option  value="1">None</option>
          ...
          />
                                ...
                                <div className="flex-initial w-full md:11/12 lg:w-6/12 bac-1">
                                    <label className="mt-6 mb-4 lable-color text-sm tracking-wide font-semibold">State</label>
                                    <div className="block mb-2 relative">
                                    <div className="custom-select mt-2">
                      <select>
                        ...
                        <div className="md:block lg:flex block box-shadow-1 rounded-2xl pt-3 px-6 sm:pt-7 mb-6 sm:mb-0 relative">
                            <div className="flex-initial w-full md:11/12 lg:w-7/12 bac-1 py-2 sm:py-12 px-2 pr-4 md:py-5 lg:py-0 mr-2 mb-0 md:mb-2 lg:mb-5">
                                ...
                                <div className="flex w-full justify-center bg-grey-lighter mb-4 mt-2">
                                    <label className="w-full flex flex-col items-center px-4 py-14 box-shadow-3 border-gray-500 text-blue rounded-lg border-2 border-dashed tracking-wide uppercase border-blue cursor-pointer">
                                    <img src={uploadicon} alt="uploadicon" />
                            ...
                            <div className="flex-initial w-full md:11/12 lg:w-7/12 bac-1 py-2 sm:py-12 px-4 sm:px-2 pr-4 md:py-5 lg:py-0 mb-0 md:mb-2 lg:mb-5">
                                <label className="mt-10 mb-2 lable-color text-base font-semibold">Upload Form Link</label>
                                <div className="block mb-2">
                                    <input type="text" id="email" placeholder="Paste here" required="" className="box-shadow-3 h-12 px-4 rounded-lg border border-[#95A5A6] bg-white lable-color w-full mt-2 mb-1 text-sm placeholder-[#95A5A6]" />
                                </div>
                            </div>
                        </div>
                    </div>
                  ...
                  <div className="relative inline-block w-[3.2rem] mr-2 align-middle select-none transition duration-200 ease-in">
                    ...
                    <div className="md:mb-5 mb-8 lg:mb-8">
                        <div className="flex justify-center sm:justify-end">
                            ...
                            <Link to={`${process.env.REACT_APP_FRONT_URL}/campaign-details-survey`} className="bac-6 w-48 py-2.5 flex rounded text-white uppercase text-base font-bold justify-center items-center">Submit </Link>
                            </div>
...
export default CampaignDetailsSampling