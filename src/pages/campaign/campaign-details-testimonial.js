...
<div className="px-5 sm:px-8">
                ...
                <div className="sm:flex block w-full social-break float-right mb-2">
                  <div className="flex-initial w-full sub-width-2 sm:w-6/12 mr-6">
                    ...
                    <div className="custom-select mt-2">
                      <select>
                        <option className="select-options color-3" value="0">Testimonials</option>
    ...
    <div className="mb-10">
      ...
      onChange={()=>setChecked({buy:!checked.buy})}
        ...
        <div className="mb-10">
            <h5 className="text-lg tracking-wide font-semibold lable-color mb-3">Task 2: Upload Product Image<span className="text-[#E74C3C]">*</span></h5>
     ...
     onChange={()=>setChecked({buugest:!checked.buugest})}
        ...
        <div className="mb-10">
            <h5 className="text-lg tracking-wide font-semibold lable-color mb-3">Task 4: Publish Approved Feedback & Images<span className="text-[#E74C3C]">*</span></h5>
    ...
    <a href="#" class="color-2 font-semibold underline text-xs">View More</a>
        ...
        <div className="block lg:flex justify-end items-center md:mb-5 mb-8 lg:mb-8">
            ...
            <div className="flex justify-end sm:justify-end">
                ...
                <Link to={`${process.env.REACT_APP_FRONT_URL}/campaign-details-sampling`} className="bac-6 w-48 py-2.5 flex rounded text-white uppercase text-base font-bold justify-center items-center">Submit </Link>
            </div>
        </div>
    </div>
