...
function CampaignDetailsServeyReview() {
  // useEffect(() => {
  //     toggleSubnav()
  //     rotateMenuBtnIcon()
  //   }, [])
            ...
            <div id="tab-contents">
              ...
              >
                <div className="block lg:flex justify-between items-center mb-3 lg:mb-7 pb-0 lg:pb-4">
                  ...
                  <div className="block sm:flex items-center mt-2">
                  <Link to={`${process.env.REACT_APP_FRONT_URL}/campaign-details-sampling-review`} className="bac-3 text-white text-sm font-semibold px-4 py-2 rounded-lg mr-5 mr5 font-11 sm:mr-8 uppercase">
    PRev Revuer
    </Link>
  <Link to={`${process.env.REACT_APP_FRONT_URL}/campaign-details-influncer-outreach-review`} className="bac-6 font-11 text-white text-sm font-semibold px-4 rounded-lg py-2 uppercase py3"> Next Revuer
                   </Link>
                  </div>
                </div>
        ...
        "
                ...
                >
                 <h4 className="texe-sm sm:text-base mr-4 lg:mb-0 mb-0 sm:mb-2 w85 lable-color">
                              <span className="font-semibold">Task 1:</span>  Fill Form
                            </h4>
...
export default CampaignDetailsServeyReview;
