export const CampaignActiveInactiveModal = ({ status_title,message,onFailure,onSuccessStatusChange}) => {
    return (
        <div className="fixed z-10 overflow-y-auto top-44 w-full left-0 hidden" id="modal">
                ...
                >
                    <div className="bg-white px-8 pt-2 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div className="flex justify-center">
                            ...
                            <button className="bac-6 w-32 font-bold py-2 text-white text-xl m-1 sm:m-3 rounded-lg" onClick={onSuccessStatusChange}>Yes</button>
                        </div>
                    </div>
                </div>
            </div>
...
export default CampaignActiveInactiveModal